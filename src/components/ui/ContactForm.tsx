...
export const ContactForm: React.FC = () => {
  ...
  return (
    <form
      ...
      className={cn(
        "bg-black rounded-[24px] sm:rounded-[28px] lg:rounded-[30px]",
        "p-5 sm:p-6 lg:p-8",
      ...
      <div className="space-y-4 sm:space-y-5 lg:space-y-6">
        ...
        {status === "success" && (
          <motion.div
            ...
            className="text-green-400 text-sm text-center p-3 bg-green-400/10 rounded-lg"
          >
        ...
        {status === "error" && (
          <motion.div
            initial={{ opacity: 0, y: -10 }}
            animate={{ opacity: 1, y: 0 }}
            className="text-red-400 text-sm text-center p-3 bg-red-400/10 rounded-lg"
          >
            {errorMessage}
          </motion.div>
        )}
        ...
        <motion.button
          ...
          className={cn(
            ...
            "py-3 sm:py-3.5 rounded-[20px] sm:rounded-[25px]",
