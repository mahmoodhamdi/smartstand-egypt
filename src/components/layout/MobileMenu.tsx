...
export const MobileMenu: React.FC = () => {
  ...
  // Menu overlay rendered via portal to escape Header's stacking context
  const menuOverlay = (
    <AnimatePresence>
      {isOpen && (
        <>
          {/* Backdrop - fully opaque to hide page content */}
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
  ...
  return (
    <div className="lg:hidden">
      ...
      {/* Render menu overlay via portal to document.body */}
